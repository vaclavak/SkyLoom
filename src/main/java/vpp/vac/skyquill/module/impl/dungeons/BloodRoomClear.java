...
public class BloodRoomClear extends Module {
	...
	public BloodRoomClear() {
		this.name = "Blood Room Alert";
		this.description = "Displays an alert on your screen when blood room gets cleared";
